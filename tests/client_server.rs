...
test_case! { path, "txt", vec!["test", "-t", "1", "path", "INIT", "REPLACE", "2MSG", "INIT"] }
test_case! { sequence, "uml", vec!["test", "-t", "1", "sequence", "INIT", "REPLACE", "2MSG", "INIT"] }
test_case! { client_states, "dot", vec!["test", "-t", "1", "states", "C"] }
test_case! { client_states_names, "dot", vec!["test", "-t", "1", "states", "C", "-n"] }
test_case! { server_states, "dot", vec!["test", "-t", "1", "states", "S"] }
test_case! { server_states_names, "dot", vec!["test", "-t", "1", "states", "S", "-n"] }
